...
import backgroundImage from "../assets/55.jpg"; // Import the background image
...
const Home = () => {
  return (
    <>
      ...
      >
        <div>
          <h1 style={{fontSize:"3em", textShadow: "2px 2px 3px rgba(0,0,0,3)"}} >Welcome to Uttam Mechanical Works</h1>
          <h4 style={{textShadow: "2px 2px 3px rgba(0,0,0,3)"}}>Your Trusted Partner in Precision Manufacturing!</h4>
        </div>
      </div>
